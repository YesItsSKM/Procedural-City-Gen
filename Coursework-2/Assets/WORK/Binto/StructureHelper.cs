...
namespace SVS
{
	public class StructureHelper : MonoBehaviour
	{
		...
		public void PlaceStructuresAroundRoad(List<Vector3Int> roadPositions)
		{
			...
			bool VerifyIfBuildingFits(int halfSize, Dictionary<Vector3Int, Direction> freeEstateSpots, KeyValuePair<Vector3Int, Direction> freeSpot, ref List<Vector3Int> tempPositionsBlocked)
			{
			...
			Dictionary<Vector3Int, Direction> FindFreeSpacesAroundRoad(List<Vector3Int> roadPositions)
			{
